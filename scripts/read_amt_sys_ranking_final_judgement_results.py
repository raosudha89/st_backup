...
model_to_no = {'ref':0, 'rule_based':1, 'smt_ensemble':2, 'nmt_baseline':3, 'nmt_copy':4, 'nmt_combined':4}
models = ['ref', 'rule_based', 'smt_ensemble', 'nmt_baseline', 'nmt_copy', 'nmt_combined']
